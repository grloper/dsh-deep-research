    ...
    function VeritasMessageActionButton(props) {
      ...
      const handleVerify = useCallback(async () => {
        ...
        try {
          ...
          const reportData = {
            ...
            phantomCount: 0,
            anchoredPct: 100,
            tribunalStatus: isContradicted ? "Refuted" : "Verified",
            summary: `${totalSources} sources → ${independentRoots} independent origins (${totalSources - independentRoots} syndicated)`,
            claims: [
              {
                text: textToVerify.slice(0, 75).trim() + (textToVerify.length > 75 ? "..." : ""),
      ...
      return h("div", { style: { display: "inline-flex", alignItems: "center", position: "relative" } },
        h("button", {
          ...
          title: "Mechanically verify factual claims & citation anchoring",
        },
          h(ShieldCheckIcon),
        ...
        showDetail && report && h("div", { className: "veritas-popover" },
          ...
          h("div", { className: "veritas-claim-row" },
            h("span", { style: { fontSize: "11px", color: "var(--dsw-alias-label-primary, #f1f5f9)" } },
            ...
            h("span", {
              style: {
                fontSize: "10.5px",
                fontWeight: 600,
                color: report.claims[0].verdict === "CONTRADICTED" ? "#f87171" : "#34d399",
                flex: "none",
              }
            },
